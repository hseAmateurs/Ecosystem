...
public:
    ...
    void update(std::vector<pathogen> &pathogens, std::vector<body> &bodys, std::vector<macro> &macros,
...
template<typename pathogen, typename body, typename macro, typename neutro>
void Cell::update(std::vector<pathogen> &pathogens, std::vector<body> &bodys, std::vector<macro> &macros,
                  std::vector<neutro> &neutros, sf::Time deltaTime) {
